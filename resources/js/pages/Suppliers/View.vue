                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
                                ...
                                <div class="flex flex-col gap-1 text-center sm:text-left">
                                    <h2 class="text-xl font-semibold">{{ supplier.supplier_name }}</h2>
                                    <p v-if="supplier.country_name" class="text-muted-foreground">{{ supplier.country_name }}</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-1">
                                    <span v-if="supplier.address_1">{{ supplier.address_1 }}</span>
                                    <span v-if="supplier.address_2">{{ supplier.address_2 }}</span>
                                    <span v-if="supplier.country_name">{{ supplier.country_name }}</span>
                                    <span v-if="!supplier.address_1 && !supplier.address_2 && !supplier.country_name" class="text-muted-foreground">
                                        No address provided
                                    </span>
                                </div>
                            </div>
                            ...
                            <template v-if="supplier.description">
                                ...
                                <div>
                                    ...
                                    <div class="prose prose-sm max-w-none dark:prose-invert" v-html="supplier.description"></div>
                                </div>
                            </template>
                            ...
                            <AuditInfo
                                ...
                                :previous-updated-by="supplier.previous_updated_by"
                                :created-at="supplier.created_at"
                                :updated-at="supplier.updated_at"
                                :previous-updated-at="supplier.previous_updated_at"
                            />
                        </div>
                    </template>
                </Card>
