                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
                                ...
                                <div class="flex flex-col gap-1 text-center sm:text-left">
                                    ...
                                    <p v-if="customer.company_name" class="text-sm text-muted-foreground">{{ customer.company_name }}</p>
                                </div>
                            </div>
                            ...
                            <div>
                                <h3 class="mb-4 text-lg font-medium">Customer Information</h3>
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Customer Since</span>
                                        <span>{{ formatDate(customer.customer_since) }}</span>
                                    </div>
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Loyalty Points</span>
                                        <span class="font-semibold">{{ customer.loyalty_points?.toLocaleString() ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
