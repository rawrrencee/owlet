                        ...
                        >
                            ...
                            <div
                                v-if="
                                    selectedEmployee &&
                                    employeeInsurances &&
                                    employeeInsurances.length > 0
                                "
                            >
                                <Divider />
                                <div class="flex flex-col gap-2">
                                    <label class="font-medium"
                                        >Existing Insurances for
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    />
                                    <small
                                        v-if="form.errors.policy_number"
                                        class="text-red-500"
                                    >
        ...
        >
            <div v-if="viewingInsurance" class="flex flex-col gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Tag
                        :value="
                            viewingInsurance.is_active ? 'Active' : 'Expired'
                        "
                        :severity="
                            viewingInsurance.is_active ? 'success' : 'secondary'
                        "
                    />
                </div>
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <span class="font-mono">{{
                                viewingInsurance.policy_number
                            }}</span>
                        </div>
                        <div class="flex flex-col gap-1">
                            <span class="text-sm text-muted-foreground"
                            ...
                            >
                            <span>{{
                                formatDate(viewingInsurance.start_date)
                            }}</span>
                        </div>
                        <div class="flex flex-col gap-1">
                            <span class="text-sm text-muted-foreground"
                            ...
                            >
                            <span>{{
                                formatDate(viewingInsurance.end_date)
                            }}</span>
                        </div>
                    </div>
                </div>
                ...
                <template v-if="viewingInsurance.has_document">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span v-if="viewingInsurance.document_filename">{{
                                viewingInsurance.document_filename
                            }}</span>
                            <span
                                v-else-if="
                                    viewingInsurance.external_document_url
                                "
                ...
                <template v-if="viewingInsurance.comments">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            v-html="viewingInsurance.comments"
                        ></div>
                    </div>
                </template>
            </div>
            ...
            <template #footer>
                <div class="flex justify-end gap-2">
                    <Button
                        ...
                        @click="
                            router.visit(
                                `/documents/insurances/${viewingInsurance?.id}`,
                            )
                        "
                    />
                    <Button
