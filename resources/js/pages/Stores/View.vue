                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
                                ...
                                <div class="flex flex-col gap-1 text-center sm:text-left">
                                    <h2 class="text-xl font-semibold">{{ store.store_name }}</h2>
                                    <Tag :value="store.store_code" severity="secondary" class="self-center sm:self-start" />
                                    <p v-if="store.company" class="text-muted-foreground">{{ store.company.company_name }}</p>
                                </div>
                            </div>
                            ...
                            <template v-if="employeeStores && employeeStores.length > 0">
                                <Divider />
                                <div>
                                    <h3 class="mb-4 text-lg font-medium">Assigned Employees</h3>
                                    <DataTable
                                    ...
                                    >
                                        ...
                                        <Column field="employee_name" header="Name">
                                            <template #body="{ data }">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <Avatar
                                                        v-else
                                                        :label="getEmployeeInitials(data.employee_name)"
                                                        shape="circle"
                                        ...
                                        <Column field="employee_number" header="Employee #" class="hidden sm:table-cell">
                                            <template #body="{ data }">
