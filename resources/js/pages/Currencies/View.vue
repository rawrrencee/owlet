...
function formatExchangeRate(): string {
    if (props.currency.exchange_rate === null || props.currency.exchange_rate === undefined) {
        return 'Not set';
    }
    const rate = typeof props.currency.exchange_rate === 'string'
                ...
                <Card>
                    <template #content>
                        <div class="flex flex-col gap-6">
                            ...
                            <div>
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <Tag :value="currency.code" severity="secondary" class="self-start" />
                                    </div>
                                    <div class="flex flex-col gap-1">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Decimal Places</span>
                            ...
                            <div>
                                <h3 class="mb-4 text-lg font-medium">Exchange Rate Information</h3>
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Exchange Rate (Base: SGD)</span>
                                        <span class="font-mono">{{ formatExchangeRate() }}</span>
                                    </div>
                                    <div class="flex flex-col gap-1">
                            ...
                            <!-- Timestamps -->
                            <div>
                                <h3 class="mb-4 text-lg font-medium">Record Information</h3>
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Created At</span>
                                        <span>{{ formatDate(currency.created_at) }}</span>
                                    </div>
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-muted-foreground">Updated At</span>
                                        <span>{{ formatDate(currency.updated_at) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
