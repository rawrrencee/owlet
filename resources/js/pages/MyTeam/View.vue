...
const showCompaniesTab = computed(() =>
    props.visibleSections.includes('companies'),
);
                    ...
                    <template #content>
                        <Tabs v-model:value="activeTab" scrollable>
                            <TabList>
                                ...
                                <Tab v-if="showCompaniesTab" value="companies"
                                    >Companies</Tab
                                >
                                <Tab v-if="showStoresTab" value="stores"
                                    >Stores</Tab
                                >
                            </TabList>
                            <TabPanels>
