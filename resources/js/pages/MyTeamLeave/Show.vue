...
function confirmApprove() {
    confirm.require({
        ...
        accept: () => {
            router.post(
                `/my-team-leave/${props.leaveRequest.id}/approve`,
                {},
                { preserveScroll: true },
            );
        },
...
function submitReject() {
    rejectForm.post(`/my-team-leave/${props.leaveRequest.id}/reject`, {
        preserveScroll: true,
        onSuccess: () => {
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            >
                <div class="flex items-center gap-3">
                    <BackButton fallback-url="/my-team-leave" />
                ...
                <div v-if="isPending && canApprove" class="flex gap-2">
                    <Button
                        label="Approve"
                        icon="pi pi-check"
                        size="small"
