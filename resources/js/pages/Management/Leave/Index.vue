...
import type { BreadcrumbItem, LeaveRequest, PaginatedData } from '@/types';
...
function onRowClick(event: any) {
    router.visit(`/management/leave/${event.data.id}`);
}
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <h1 class="heading-lg">Leave Requests</h1>
            ...
            >
                ...
                <Column header="Employee" :style="{ width: '25%' }">
                    <template #body="{ data }">
