...
const form = useForm({
    ...
    date_of_birth: props.employee?.date_of_birth
        ? new Date(props.employee.date_of_birth)
        : null,
    ...
    pr_conversion_date: props.employee?.pr_conversion_date
        ? new Date(props.employee.pr_conversion_date)
        : null,
    ...
    hire_date: props.employee?.hire_date
        ? new Date(props.employee.hire_date)
        : null,
    termination_date: props.employee?.termination_date
        ? new Date(props.employee.termination_date)
        : null,
...
onMounted(() => {
    ...
    removeBeforeListener = router.on('before', (event) => {
        ...
        if (
            form.isDirty &&
            !pendingNavigation &&
            (activeTab.value === 'basic' || !isEditing.value)
        ) {
...
const profilePictureUrl = computed(
    () => props.employee?.profile_picture_url ?? null,
);
...
function submit() {
    ...
    form.transform((data) => ({
        ...
        emergency_relationship:
            relationshipSelection.value === 'Other'
                ? relationshipOther.value
                : relationshipSelection.value,
        date_of_birth: data.date_of_birth
            ? formatDateForBackend(data.date_of_birth as Date)
            : null,
        pr_conversion_date: data.pr_conversion_date
            ? formatDateForBackend(data.pr_conversion_date as Date)
            : null,
        hire_date: data.hire_date
            ? formatDateForBackend(data.hire_date as Date)
            : null,
        termination_date: isActive.value
            ? null
            : data.termination_date
              ? formatDateForBackend(data.termination_date as Date)
              : null,
    }));
                ...
                <Card v-if="!isEditing">
                    <template #content>
                        ...
                        >
                            ...
                            >
                                Create a new employee. They will receive an
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <label
                                                for="pr_conversion_date"
                                                class="font-medium"
                                                >PR Conversion Date</label
                                            >
                                            <DatePicker
                                                id="pr_conversion_date"
                                                v-model="
                                                    form.pr_conversion_date
                                                "
                                                :invalid="
                                                    !!form.errors
                                                        .pr_conversion_date
                            ...
                            <div>
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        />
                                        <small
                                            v-if="form.errors.emergency_contact"
                                            class="text-red-500"
                                        >
                                            {{ form.errors.emergency_contact }}
                                        </small>
                            ...
                            <div
                                class="border-surface-300 dark:border-surface-600 dark:bg-surface-800/50 rounded-lg border border-dashed bg-muted p-4"
                            >
                                <h3
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span
                                        class="bg-surface-200 dark:bg-surface-700 inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-sm text-muted-foreground"
                                    >
                        ...
                        <Tabs v-model:value="activeTab" scrollable>
                            ...
                            <TabPanels>
                                <TabPanel value="basic">
                                    ...
                                    >
                                        <Message
                                            v-if="hasWorkOSAccount"
                                            severity="info"
                                            :closable="false"
                                        >
                                            This user is managed via WorkOS.
                                            Changes to name and role will sync
                                            to WorkOS.
                                        </Message>
                                        ...
                                        <Message
                                            v-else-if="!hasWorkOSAccount"
                                            severity="warn"
                                            :closable="false"
                                        >
                                            This employee does not have a WorkOS
                                            account. Only local employee data
                                            will be updated.
                                        </Message>
                                            ...
                                            <div class="flex flex-col gap-4">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                        <div
                                                            class="flex h-[30px] items-center gap-3"
                                                        >
                                                            <ToggleSwitch
                                                                v-model="
                                                                    isActive
                                        ...
                                        <div>
                                            ...
                                            <div class="flex flex-col gap-4">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <label
                                                            for="edit_emergency_relationship"
                                                            class="font-medium"
                                                            >Relationship</label
                                                        >
                                                        <Select
