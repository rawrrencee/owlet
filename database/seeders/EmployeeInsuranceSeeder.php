...
class EmployeeInsuranceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $insurancesPerEmployee = config('seeders.counts.insurances_per_employee', 1);
        ...
        foreach ($employees as $employee) {
            for ($i = 1; $i <= $insurancesPerEmployee; $i++) {
                $startDate = $employee->hire_date ?? $faker->dateTimeBetween('-2 years', '-3 months');
                ...
                EmployeeInsurance::create([
                    ...
                    'end_date' => $faker->optional(0.7)->dateTimeBetween('+6 months', '+3 years'),
